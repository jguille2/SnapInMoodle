...
/**
 * Provides the information to backup #snapPluginApp# submissions.
 *
 * @package   assignsubmission_#snapPluginName#
 * @copyright 2020 Sara Arjona <sara@moodle.com> and Joan Guillén <jguille2@xtec.cat>
 * @license   http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
class backup_assignsubmission_#snapPluginName#_subplugin extends backup_subplugin {
    ...
    protected function define_submission_subplugin_structure() {
        ...
        $subpluginelement = new backup_nested_element('submission_#snapPluginName#',
                                                      null,
                                                      ['#snapPluginName#_xmlproject', 'submission']);
