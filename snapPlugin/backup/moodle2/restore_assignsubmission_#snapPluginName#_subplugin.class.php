 ...
 * @license   http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
class restore_assignsubmission_#snapPluginName#_subplugin extends restore_subplugin {
    ...
    protected function define_submission_subplugin_structure() {
        ...
        $elepath = $this->get_pathfor('/submission_#snapPluginName#');
    ...
    /**
     * Processes one assignsubmission_#snapPluginName# element
     *
     * @param mixed $data
     */
    public function process_assignsubmission_#snapPluginName#_submission($data) {
        global $DB;
