...
namespace assignsubmission_#snapPluginName#\privacy;
...
class provider implements
    ...
    public static function export_submission_user_data(assign_plugin_request_data $exportdata) {
        ...
        $plugin = $assign->get_plugin_by_type('assignsubmission', '#snapPluginName#');
        $submission = $exportdata->get_pluginobject();
        $editortext = $plugin->get_editor_text('#snapPluginName#', $submission->id);
        if (!empty($editortext)) {
            $submissiontext = new \stdClass();
            $currentpath = $exportdata->get_subcontext();
            $currentpath[] = get_string('privacy:path', 'assignsubmission_#snapPluginName#');
