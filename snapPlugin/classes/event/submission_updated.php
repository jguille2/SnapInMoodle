...
/**
 * The assignsubmission_#snapPluginName# submission_updated event.
 *
...
/**
 * The assignsubmission_#snapPluginName# submission_updated event class.
 *
 * @package   assignsubmission_#snapPluginName#
 * @copyright 2020 Sara Arjona <sara@moodle.com> and Joan Guillén <jguille2@xtec.cat>
 * @license    http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
...
class submission_updated extends \mod_assign\event\submission_updated {
    ...
    public function get_description() {
        $descriptionstring = "The user with id '$this->userid' updated an #snapPluginApp# submission " .
