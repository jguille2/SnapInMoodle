...
/**
 * The assignsubmission_#snapPluginName# assessable uploaded event.
 *
...
/**
 * The assignsubmission_#snapPluginName# assessable uploaded event class.
 *
 * @package   assignsubmission_#snapPluginName#
 * @copyright 2020 Sara Arjona <sara@moodle.com> and Joan Guillén <jguille2@xtec.cat>
 * @license    http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
...
class assessable_uploaded extends \core\event\assessable_uploaded {
    ...
    public function get_description(): string {
        return "The user with id '$this->userid' has saved an #snapPluginApp# submission with id '$this->objectid' " .
    ...
    public static function get_name(): string {
        return get_string('eventassessableuploaded', 'assignsubmission_#snapPluginName#');
    }
